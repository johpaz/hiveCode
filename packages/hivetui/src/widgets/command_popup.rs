...
pub const COMMANDS: &[Command] = &[
    ...
    Command { cmd: "/mode",     desc: "Cambiar modo (plan/aprobación/auto)" },
    Command { cmd: "/provider", desc: "Configurar provider LLM" },
    Command { cmd: "/logs",     desc: "Mostrar/ocultar logs" },
    Command { cmd: "/clear",    desc: "Limpiar historial" },
    Command { cmd: "/timeline", desc: "Ver checkpoints" },
];
